                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      onChanged: (_) =>
                                                        ...
                                                        Duration(
                                                            milliseconds: 2000),
                                                        () async {
                                                          if (functions.validatePasswordLogIn(_model
                                                                      .passwordTextController
                                                                      .text) !=
                                                                  null &&
                                                              functions.validatePasswordLogIn(_model
                                                                      .passwordTextController
                                                                      .text) !=
                                                                  '') {
                                                            FFAppState()
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 0.0,
                                                                0.0, 16.0),
                                                    child: FFButtonWidget(
                                                      onPressed: ((functions.validateEmail(_model
                                                                          .emailAddressTextController
                                                                          .text) !=
                                                                      null &&
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        decoration:
                                                          ...
                                                          alignLabelWithHint:
                                                              false,
                                                          hintText:
                                                              'Please enter your Saudi National Address',
                                                          hintStyle:
                                                              FlutterFlowTheme.of(
                                                                      context)
                                                                  .labelMedium
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        AlignedTooltip(
                                                          content: Text(
                                                            'A plant nanny is someone who takes care of your plants when you\'re away, ensuring they\'re watered, get sunlight, and stay healthy.',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                          ...
                                                          content: Padding(
                                                            padding:
                                                                EdgeInsets.all(
                                                                    4.0),
                                                            child: Text(
                                                              'A plant expert offers specialized knowledge and advice for plant care. ',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodySmall
                                                                  .override(
                                                          ...
                                                          return FFButtonWidget(
                                                            onPressed:
                                                              ...
                                                              Function()
                                                                  _navigate =
                                                                  () {};
                                                              if (buttonUserDetailsRecordList
                                                                  .isNotEmpty) {
                                                                FFAppState()
                                                                        .emailPhoneExistErrorMsg =
                                                                    'The email address or phone number you entered is already registered. Please try logging in or use a different email address/phone number to create a new account.';
                                                                safeSetState(
                                                                    () {});
                                                              } else {
                                                                FFAppState()
