...
class SignInSignUpModel extends FlutterFlowModel<SignInSignUpWidget> {
  ...
  // Stores action output result for [Custom Action - customAuthLogin] action in Button widget.
  String? signInResult;
  ...
  // Stores action output result for [Custom Action - customAuthSignUp] action in Button widget.
  String? returnAuth;
